...
export default function AnalogClock() {
  ...
  return (
    <Fragment>
      <div className="size-96 rounded-full relative">
        <div className="absolute w-full h-full bg-indigo-500 bg-opacity-50 blur-3xl rounded-full" />
        <div className="absolute w-full h-full bg-purple-500 bg-opacity-50 blur-2xl rounded-full" />
      ...
      <div className="w-4/5 md:w-1/2 absolute bottom-8">
        <div className="flex items-center justify-center gap-2 text-xl text-slate-200 font-medium font-mono">
          Developed {">"}
          <a
